...
class _NormalAddressState extends State<NormalAddress> {
  ...
  List<String> _pickupLocation = ["hello","aaa"];
          ...
          children: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () async {
                ...
                if( await _saveNormalAddress(_addressNameController.value.text.trim(),_addressDescriptionController.value.text.trim(),_addressDescriptionController.value.text)){
