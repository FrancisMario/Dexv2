            ...
            flexibleSpace: TabBar(
              tabs: [
                Padding(
                  ...
                  child: Tab(icon: SvgPicture.asset("assets/icons/food-delivery.svg", width: size.width * 0.05, height: size.height * 0.05, color: Colors.white,),text: "Delivery"),
                ),
                Padding(
                  padding: const  EdgeInsets.only(top:20.0),
                  child: Tab(icon: SvgPicture.asset("assets/icons/burger.svg", width: size.width * 0.05, height: size.height * 0.05, color: Colors.white,),text: "DEx Eats",),
                ),
                Padding(
                  padding: const  EdgeInsets.only(top:20.0),
                  child: Tab(icon: SvgPicture.asset("assets/icons/location.svg", width: size.width * 0.05, height: size.height * 0.05, color: Colors.white,),text: "Addresses",),
                ),
                Padding(
                  padding: const  EdgeInsets.only(top:20.0),
                  child: Tab(icon: SvgPicture.asset("assets/icons/messaging.svg", width: size.width * 0.05, height: size.height * 0.05, color: Colors.white,),text: "messaging",),
                ),
              ],
            ),
            ),
                  ...
                  originalcart: 
                    {
                      ...
                      "Burger":{
                        "price":300,
                        "image":"https://media-cdn.tripadvisor.com/media/photo-s/0e/4c/78/29/beef-burget.jpg",
                        "quantity":1
                        },
                      "Cake":{
                        "price":500,
                        "image":"https://images.immediate.co.uk/production/volatile/sites/30/2020/08/carrot-cake-8d8dfb5.jpg?quality=90&resize=960,872",
                        "quantity":1
                        },
                      "Chicken":{
                        "price":300,
